...
export class partidosPasadosService{
    ...
    PartidosPasados = [
        {Id: 1, Titulo:'Partido Buen Consejo', Fecha:'Sabado, 26 de Marzo 18:30', Lugar: 'Centro Arganzuela', Direccion: 'C/Canarias 17. 28045 MADRID, Palos de la Frontera', Metro: 'Metro Palos de la Frontera', Ubicacion: '', JugadoresApuntados: [1,2,3,4,5,9]},
        ...
        {Id: 3, Titulo:'Liga Jueves', Fecha:'Jueves, 28 de Marzo 21:30', Lugar: 'Colegio mal Consejo', Direccion: 'C/Canarias 17. 28045 MADRID, Palos de la Frontera', Metro: 'Metro Palos de la Frontera', Ubicacion: '', JugadoresApuntados: [1,2,3,4,5,9]},
